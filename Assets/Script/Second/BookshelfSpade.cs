...
public class BookshelfSpade : MonoBehaviour
{
    ...
    void Start()
    {
        int selectedContainerIndex = PlayerPrefs.GetInt("BookshelfSpade_SelectedContainerIndex", -1);
        int selectedBookIndex = PlayerPrefs.GetInt("BookshelfSpade_SelectedBookIndex", -1);
